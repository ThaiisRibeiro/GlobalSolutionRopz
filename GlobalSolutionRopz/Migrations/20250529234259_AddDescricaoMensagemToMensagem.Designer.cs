...
namespace GlobalSolutionRopz.Migrations
{
    ...
    [Migration("20250529234259_AddDescricaoMensagemToMensagem")]
    partial class AddDescricaoMensagemToMensagem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GlobalSolutionRopz.Model.Mensagem", b =>
                {
                    ...
                    b.Property<string>("descricao_mensagem")
                        .IsRequired()
                        .HasColumnType("NVARCHAR2(2000)")
                        .HasColumnName("descricao_mensagem");
